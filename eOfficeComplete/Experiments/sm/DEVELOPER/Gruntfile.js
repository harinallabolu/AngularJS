  ...
  grunt.initConfig({
	...
	'sass': {
	  development: {
	    ...
	    files: {
          "<%= globalConfig.src %>/UNMINIFIED_CSS/bootstrap.css": "<%= globalConfig.src %>/SASS_FILES/scss/bootstrap.sass",
	      "<%= globalConfig.src %>/UNMINIFIED_CSS/smartadmin-production.css": "<%= globalConfig.src %>/SASS_FILES/scss/smartadmin-production.sass",
	      "<%= globalConfig.src %>/UNMINIFIED_CSS/font-awesome.css": "<%= globalConfig.src %>/SASS_FILES/scss/library/fontawesome/font-awesome.sass",
	      "<%= globalConfig.src %>/UNMINIFIED_CSS/smartadmin-skins.css": "<%= globalConfig.src %>/SASS_FILES/scss/smartadmin-skin/smartadmin-skins.sass"
	    }
	  }
	},	
